...
class _HomePageState extends State<HomePage> {
  List<String> categories = ["Shawarma", "Burgers", "Kebab", "Pulao", "Salad"];
  List<dynamic> foods = [{
            ...
            Expanded(
              child: Padding(
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (context, index) =>
                        FadeAnimation(1, makeItem(image: foods[index]["image"],
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: selectedCategory == index ? Colors.orange[700] : Colors
              .grey[300],
                    ...
                    child: Align(
                      ...
                      child: AnimatedContainer(
                          ...
                          child: isFavorite ? Icon(Icons.favorite, color: Colors
                              .red,) : Icon(Icons.favorite, color: Colors
                              .white,)),
                    ),
                  ),
                  Column(
