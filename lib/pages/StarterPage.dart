        ...
        child: Container(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                FadeAnimation(.5, Text('Taking Orders Faster Than Ever', style: TextStyle(color: Colors.white, fontSize: 50, fontWeight: FontWeight.bold),)),
                SizedBox(height: 20,),
                FadeAnimation(1, Text("Check nearby restaurants by \nadding location", style: TextStyle(color: Colors.white, height: 1.4, fontSize: 18),)),
                SizedBox(height: 100,),
                FadeAnimation(1.2,
                  ScaleTransition(
                      scale: _animation,
                ...
                FadeAnimation(1.4,
                    AnimatedOpacity(
                      ...
                      duration: Duration(milliseconds: 50),
                      child: Align(
                        child: Text("Now Delivering To Your Door 24/7", style: TextStyle(color: Colors.white70, fontSize: 15),),
                      ),
                    )),
                SizedBox(height: 30,),
              ],
